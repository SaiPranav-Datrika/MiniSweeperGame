...
class GameActivity : AppCompatActivity(),View.OnClickListener{
   ...
   // }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imgbtn= arrayOf(findViewById(btnid[0]),findViewById(btnid[1]),findViewById(btnid[2]),findViewById(btnid[3]),findViewById(btnid[4]),findViewById(btnid[5]),findViewById(btnid[6]),findViewById(btnid[7]),findViewById(btnid[8]),findViewById(btnid[9]),findViewById(btnid[10]),
                ...
                findViewById(btnid[61]),findViewById(btnid[62]),findViewById(btnid[63]))
